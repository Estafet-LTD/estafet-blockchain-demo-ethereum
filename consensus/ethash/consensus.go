...
var (
	...
	calcDifficultyEip2384 = big.newInt(1)

	//TODO Commented due to Dev Reason
	...
	calcDifficultyConstantinople = big.newInt(1)
	...
	calcDifficultyByzantium = big.newInt(1)
	
	//TODO Commented due to Dev Reason
	//makeDifficultyCalculator(big.NewInt(3000000))
)
