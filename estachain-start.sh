...
$ESTACHAIN --rpc --rpcport $RPC_PORT --rpcapi "$RPC_API" --rpcaddr $RPC_ADDR --rpccorsdomain "*" --rpcvhosts $RPC_VHOST --datadir $DATADIR --nousb --networkid 123 --nodiscover --targetgaslimit '9000000000000' --mine --miner.threads 4 --keystore $KEYSTORE
  #--syncmode "full" \
  #--mine \
  #--miner.threads 1 \
  #--verbosity 4 \
